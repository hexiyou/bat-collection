...
::ZQ05rAF9IAHYFVzEqQITMRxDRQoF3rI/4W6ZGCd+BSICW4V9
::eg0/rx1wNQPfEVWB+kM9LVsJDCebO3yzCIou3ca16vKCwg==
::fBEirQZwNQPfEVWB+kM9LVsJDCebO3yzCIou3cab
::cRolqwZ3JBvQF1fEqQITMRxDRQrCOmSoRpYQ4evwahpIJ6fV0Rv3GA==
...
::Zh4grVQjdCuDJHyc4FAxFxldQjiBJWytD7tR7ufpoumLq04WGucnfe8=
::YB416Ek+ZG8=
::
::
...
set "DirectoryRunWrapper=%installDrive%\cygwin64\DirectoryRun.bat"
set "exeHost=%~f0x"
set "args=%*"
set "myself=%~df0"
REM echo %myself%
